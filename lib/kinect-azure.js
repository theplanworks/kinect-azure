const kinect =
	process.platform !== "darwin"
		? require("bindings")("kinectAzure")
		: require("./kinect-dummy");

class KinectAzure {
	constructor() {
        kinect.init();
        kinect.startDebug( msg => console.log(msg));
	}
	/**
	...
	startRecording(outputPath) {
		return kinect.startRecording(outputPath);
	}
	stopRecording() {
		return kinect.stopRecording();
	}
